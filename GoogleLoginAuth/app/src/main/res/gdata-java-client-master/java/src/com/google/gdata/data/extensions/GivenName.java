...
public class GivenName extends AbstractExtension {
   ...
   */
  public GivenName(String value, String yomi) {
    super();
    setValue(value);
    setYomi(yomi);
    setImmutable(true);
  ...
  public static ExtensionDescription getDefaultDescription(boolean required,
    ...
    ExtensionDescription desc =
        ExtensionDescription.getDefaultDescription(GivenName.class);
  ...
  public String toString() {
    return "{GivenName value=" + value + " yomi=" + yomi + "}";
  }
