...
/**
 * Contact's additional (often: middle) name.
 *
 * 
 */
@ExtensionDescription.Default(
    ...
    nsUri = Namespaces.g,
    localName = AdditionalName.XML_NAME)
public class AdditionalName extends AbstractExtension {
   ...
   */
  public AdditionalName(String value, String yomi) {
    super();
    setValue(value);
    setYomi(yomi);
    setImmutable(true);
  ...
  public static ExtensionDescription getDefaultDescription(boolean required,
    ...
    ExtensionDescription desc =
        ExtensionDescription.getDefaultDescription(AdditionalName.class);
  ...
  public String toString() {
    return "{AdditionalName value=" + value + " yomi=" + yomi + "}";
  }
