...
/**
 * Contact type used for feed and entry authors and contributors. It may also
...
public class Person extends ExtensionPoint implements IPerson {
  ...
  /**
   * Constructs a new Contact instance with the specified name.
   */
  ...
  /**
   * Constructs a new Contact instance with the specified name, URI,
   * and email address.
   */
   ...
   * Generates XML.
   * <p>
   * Designed to be used by {@link ExtensionPoint} types that reuse Contact.
   */
  @Override
