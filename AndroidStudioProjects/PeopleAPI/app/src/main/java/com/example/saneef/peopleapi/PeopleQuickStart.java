package com.example.saneef.peopleapi;
...
public class PeopleQuickstart {
    ...
    public static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in =
                PeopleQuickstart.class.getResourceAsStream("/com/example/saneef/peopleapi/client_secret.json");
    ...
    public PeopleQuickstart() throws IOException {
        try{
